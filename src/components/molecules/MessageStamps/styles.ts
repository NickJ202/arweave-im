...
export const Action = styled.button<{ disabled: boolean }>`
	...
	background: ${(props) => props.disabled ? props.theme.colors.button.primary.disabled.background : props.theme.colors.button.primary.background};
    border: 1px solid ${(props) => props.disabled ? props.theme.colors.border.alt2 : props.theme.colors.button.primary.border};
	border-radius: 20px;
	padding: 1.5px 0 0 0;
	svg {
		height: 12.5px;
    ...
    &:hover {
        ...
        border: 1px solid ${(props) => props.disabled ? props.theme.colors.button.primary.border : props.theme.colors.button.primary.active.border};
    }
`;
